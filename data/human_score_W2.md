...
|------------|--------|---------|
| Macro / News Weight | 0 | Supportive macro but NFP remains a major risk. |
| Technical Structure | +1 | Price remains above both the 8 EMA and 21 EMA, trendline support remains intact, and the technical structure is still bullish. However, only 57% of stocks remain above their 200-day moving average, so conviction is reduced. |
| Almanac Seasonal Weight | -1 | Midterm-year weakness and Memorial Day statistics create a headwind. |
| AI Agreement Quality | +1 | All four AI models agreed on a bullish outlook. |
| Wild Card | -1 | The bullish outlook depends heavily on momentum surviving the NFP event risk. |
