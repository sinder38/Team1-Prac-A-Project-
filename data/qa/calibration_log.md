...
I found the actual results in the repo, but I could not find the locked prediction file with the original confidence levels. Because of that, I should not claim High or Medium confidence after the result is already known. I am using the lowest score bucket as a safe QA decision.

## Current Week 2 score

| Asset | Prediction shown in actuals file | Actual result | Direction result | Confidence proof found? | Score used |
| --- | --- | ---: | --- | --- | ---: |
